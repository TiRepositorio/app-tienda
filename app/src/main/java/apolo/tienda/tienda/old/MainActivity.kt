...
import apolo.tienda.tienda.old.utilidades.ConexionWS
import apolo.tienda.tienda.old.utilidades.TablasSincronizacion
import apolo.tienda.tienda.old.utilidades.UtilidadesBD
    ...
    companion object{
        ...
        private class Conexion : AsyncTask<Void?, Void?, Void?>() {
            ...
            override fun doInBackground(vararg params: Void?): Void? {
                Usuario.usuario = etUsuario.text.toString().uppercase()
                Usuario.clave   = etPassword.text.toString().uppercase()
                try {
                    conn = ConnectionDB.getConnectionDB(Usuario.usuario, Usuario.clave)
                } catch(e : Exception) {
                    cerrarConexion()
